...
//type MQTTRTCommunicationCmdTemplate struct {
...
func MQTTFeisjyAddCommunicationMessage(service *ReportServiceParamFeisjyTemplate, label string, dir int, buf string) {
