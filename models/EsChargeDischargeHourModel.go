...
type EsChargeDischargeHourModel struct {
	Ts                LocalTime       `json:"ts" gorm:"comment:'时间戳'"`
...
func (u *EsChargeDischargeHourModel) TableName() string {
	return "charge_discharge_hour"
}
